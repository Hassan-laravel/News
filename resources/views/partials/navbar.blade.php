...
<div class="bg-light border-bottom py-2 d-none d-lg-block">
    <div class="container d-flex justify-content-between align-items-center small">
        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="d-flex align-items-center gap-3">
                <a href="https://facebook.com" target="_blank" class="text-secondary hover-primary"><i class="bi bi-facebook"></i></a>
                <a href="https://twitter.com" target="_blank" class="text-secondary hover-primary"><i class="bi bi-twitter-x"></i></a>
                <a href="https://instagram.com" target="_blank" class="text-secondary hover-primary"><i class="bi bi-instagram"></i></a>
                <a href="https://youtube.com" target="_blank" class="text-secondary hover-primary"><i class="bi bi-youtube"></i></a>
            </div>
        </div>

        <div class="d-flex align-items-center gap-3">
            <div class="dropdown border-start ps-3">
                <button class="btn btn-sm btn-outline-secondary dropdown-toggle border-0 shadow-none" data-bs-toggle="dropdown">
            ...
            <div class="collapse navbar-collapse d-none d-lg-block">
                <ul class="navbar-nav mx-auto gap-3">
                    @foreach($categories as $category)
                        <li class="nav-item">
                            <a class="nav-link fw-medium text-dark" href="/category/{{ $category['id'] }}">{{ $category['name'] }}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
    ...
    <div class="offcanvas {{ app()->getLocale() == 'ar' ? 'offcanvas-start' : 'offcanvas-start' }} d-lg-none" tabindex="-1" id="mobileMenu" style="width: 280px;">
            ...
            <div class="accordion accordion-flush" id="menuAccordion">
                ...
                <div class="accordion-item border-0">
                    <h2 class="accordion-header">
                        <button class="accordion-button fw-bold bg-white shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCats">
                    ...
                    <div id="collapseCats" class="accordion-collapse collapse show" data-bs-parent="#menuAccordion">
                        <div class="accordion-body p-0">
                            <div class="list-group list-group-flush">
                                @foreach($categories as $category)
                                    <a href="/category/{{ $category['id'] }}" class="list-group-item list-group-item-action border-0 ps-5 py-2 small">
                                         {{ $category['name'] }}
                                    </a>
                                @endforeach
                            </div>
                ...
                <div class="accordion-item border-0 mt-1">
                    <h2 class="accordion-header border-top">
                        <button class="accordion-button collapsed fw-bold bg-white shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePages">
                    ...
                    <div id="collapsePages" class="accordion-collapse collapse" data-bs-parent="#menuAccordion">
                        <div class="accordion-body p-0 border-bottom">
                            <div class="list-group list-group-flush">
                                @foreach ($pages as $page)
                                    <a class="list-group-item list-group-item-action border-0 ps-5 py-2 small" href="{{ route('page', $page['slug']) }}">
                                        {{ $page['title'] }}
                                    </a>
                                @endforeach
                                <a class="list-group-item list-group-item-action border-0 ps-5 py-2 small" href="{{ route('contact') }}">
                                    Contact Us
                                </a>
                            </div>
                        </div>
