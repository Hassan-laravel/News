        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="post-gallery mt-5">
                    <h3 class="mb-4">{{ app()->getLocale() == 'ar' ? 'معرض الصور' : 'Photo Gallery' }}</h3>
                    <div class="row g-3">
                        @foreach($post['gallery'] as $image)
                            <div class="col-md-4 col-6">
                                <a href="{{ $image['url'] }}" target="_blank">
                                    <img src="{{ $image['url'] }}" class="img-thumbnail shadow-sm shadow-hover" alt="gallery">
                                </a>
                            </div>
                        @endforeach
                    </div>
...
<style>
    .post-details { background-color: #f8f9fa; min-height: 100vh; }
    .post-content {
        line-height: 1.8;
        color: #333;
        text-align: justify;
